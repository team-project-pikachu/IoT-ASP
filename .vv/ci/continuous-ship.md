...
| Deploy **notifications** (webhooks → HMAC → optional `repository_dispatch`) | `docs/vercel-webhooks.md`, `.github/workflows/vercel-webhook.yml`, `scripts/vercel_webhook_verify.py` (issue #37; complementary to #27) |
