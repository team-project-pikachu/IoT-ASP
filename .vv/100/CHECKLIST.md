# Checklist — #100 platform matrix

- [x] Delivery surfaces table (Vercel / iOS / Playground)
- [x] Hardware rows (Nest cams / doorbell / phone / Sonos)
- [x] Event classes (`sound_burst`, `glass_shatter`, SDM Camera*)
