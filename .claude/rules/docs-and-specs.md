...
- One spec per Project 5 issue in `docs/specs/<issue>-<slug>.md` with sections: Status · Goal · Shipped on `main` (cite `file:line`) · Remaining scope · Wire fields · Clamps / safety · Acceptance tests · CI gate · Risks / HW limits · Sources.
