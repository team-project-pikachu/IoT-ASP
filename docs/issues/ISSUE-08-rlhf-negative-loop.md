# ISSUE-08 — RLHF negative loop

**Issue:** https://github.com/team-project-pikachu/IoT-ASP/issues/8  
**Classification:** parked stub (Balanced election)  
**Owner surface:** frontend  
**Canonical spec / ADR:** `docs/specs/07-08-rlhf-loops.md`

## Scope (this pass)

Design-only stub paired with #7.
...
- Same θ vector as positive loop
