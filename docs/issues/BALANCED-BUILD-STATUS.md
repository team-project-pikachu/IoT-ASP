...
**Branch tip:** `feat/balanced-mvp-roadmap-docs` (stack PR6; base PR5 `feat/balanced-test-native-ci`)
**Date:** 2026-09-08
...
| #11 | static deepen | Fleet polish (non-React) | `public/index.html` |
...
| #27 | docs+name-check | Vercel Actions secrets | names-only + Development item title note |
...
| #60 | stub | ADK Cloud Run deploy | `ISSUE-60-*` |
| #61 | qs+UI | Backend URL wiring | `?patch=` / `?telemetry=` + `telemetryUrlLabel` |
| #62 | checklist | Field acceptance + e2e | `ISSUE-62-*`, `tests/e2e/` |
...
- **Owner-gated:** #27 secrets, #26 live GCS, #41 SensorKit, #60/#61 live URLs, #63 apply, #64 pass rows, HW labs.
