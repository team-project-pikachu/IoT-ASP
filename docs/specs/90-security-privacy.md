# #90 — Security/privacy: no credentials in git; OAuth scopes; recording consent

## Status

in progress — no credentials in repo; redaction in scripts

## Goal

Security/privacy: no credentials in git; OAuth scopes; recording consent.
...
Owner consent UX + live scope review in Home console.
