# #95 — Glass shatter discovery as event-triggered acoustic class

## Status

stubbed — event class discovery path

## Goal

Glass shatter discovery as event-triggered acoustic class.
...
Real shatter ML / dataset; not heuristic-only.
