...
in progress — matrix documented in milestone

## Goal

Platform matrix: Vercel / iOS / Playground × Nest hardware × SDM events.
...
Fill cells as surfaces land (#101/#102 still pending).
