# #91 — App scaffold + Home SDK SPM/CocoaPods placeholder that builds without proprietary SDK

## Status

implemented stub — native/IoTASPHome swift build

## Goal

App scaffold + Home SDK SPM/CocoaPods placeholder that builds without proprietary SDK.
...
Vendored/live GoogleHomeSDK when owner licenses binary.
