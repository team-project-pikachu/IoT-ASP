# #84 — Discover Nest cameras / Device API camera traits for catalog context

## Status

stubbed on branch — Device API traits scaffold

## Goal

Discover Nest cameras / Device API camera traits for catalog context.
...
Live GoogleHomeSDK discovery against premium Nest devices.
