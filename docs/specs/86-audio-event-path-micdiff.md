# #86 — Define Nest mic or ASP micDiff → burst feature vector path

## Status

stubbed — AcousticEventFeatures path documented

## Goal

Define Nest mic or ASP micDiff → burst feature vector path.
...
Live Nest mic ingest; wire to detector beyond stub features.
