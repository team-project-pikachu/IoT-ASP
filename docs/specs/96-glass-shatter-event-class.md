# #96 — Model/event class enum shared Python/Swift (`escalateDb`, eventClass)

## Status

implemented stub — sound_burst | glass_shatter wire keys

## Goal

Model/event class enum shared Python/Swift (`escalateDb`, eventClass).
...
Calibrated thresholds on real glass events.
