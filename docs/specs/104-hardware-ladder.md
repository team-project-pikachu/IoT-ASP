# #104 — Hardware ladder: Nest cam variants / doorbell / phone mic / Sonos sinks

## Status

parked — hardware ladder research

## Goal

Hardware ladder: Nest cam variants / doorbell / phone mic / Sonos sinks.
...
Owner inventory + latency measurements on owned devices.
