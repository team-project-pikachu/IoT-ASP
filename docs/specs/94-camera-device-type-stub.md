# #94 — Camera device type integration stub via Home Device API

## Status

stubbed — NestCameraCatalog / device type integration

## Goal

Camera device type integration stub via Home Device API.
...
Live trait enumeration from Nest hardware.
