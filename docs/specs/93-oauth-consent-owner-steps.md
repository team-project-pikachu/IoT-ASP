# #93 — Document OAuth consent steps for betty@bearresearch

## Status

parked — owner-only consent steps

## Goal

Document OAuth consent steps for betty@bearresearch.io.
...
Owner completes consent; agents do not browser-login.
