# #102 — Swift Playground / Xcode playground-adjacent HomeNestAlarm stub

## Status

pending — swift build only; no Playgrounds workflow yet

## Goal

Swift Playground / Xcode playground-adjacent HomeNestAlarm stub.
...
Add Playgrounds instructions under native/IoTASPHome or keep pending.
