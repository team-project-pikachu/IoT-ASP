# #101 — Vercel PWA Nest/SDM + glass_shatter event UI surface

## Status

pending — no public/ glass_shatter UI in this PR

## Goal

Vercel PWA Nest/SDM + glass_shatter event UI surface.
...
Implement PWA fields/UI or keep parked until a dedicated PR.
