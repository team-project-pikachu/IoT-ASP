# #88 — Escalate alarm louder over time via alarmState/volBlast concepts

## Status

stubbed — EscalatingAlarmController in HomeNestAlarm

## Goal

Escalate alarm louder over time via alarmState/volBlast concepts.
...
Device-validated escalation timings and Hold/Manual clamps on hardware.
