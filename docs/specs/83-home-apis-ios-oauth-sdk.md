# #83 — Register Home APIs iOS OAuth + SDK path for Nest camera access

## Status

parked — owner-gated OAuth/console; scaffold docs only

## Goal

Register Home APIs iOS OAuth + SDK path for Nest camera access.
...
Owner completes Google Home Developer Console + OAuth as betty@bearresearch.io.
