...
implemented stub — heuristic detector + pytest

## Goal

gcloud/Vertex Gemini Enterprise burst detector stub (no metered calls by default).
...
Optional live Gemini Enterprise path after owner enablement.
