...
| Beam clean max (AirPlay) | UI 100% (C4) + digital peak **0.60** headroom; macOS/AirPlay ≤~60% or Volume Limit; Night/Speech/Loudness **OFF** — avoids click/clip/**static** on **Mac Studio (M4 Max) → Beam** field path ([sonos-beam-gen2-airplay-volume-constraints.md](sonos-beam-gen2-airplay-volume-constraints.md)) |
