...
Ingest file: scrape_-20260907T233021Z.json

**Released!** [ADK TypeScript 2.0 GA](https://adk.dev/2.0/)
is now available with graph workflows support! [Get started](https://adk.dev/graphs/#typescript)

[![logo](https://adk.dev/assets/agent-development-kit.png)](https://adk.dev/ "Agent Development Kit (ADK)")

[Agent Development Kit (ADK)](https://adk.dev/ "Agent Development Kit (ADK)")
...
[![Python](https://adk.dev/assets/icon-python.svg)Python](https://github.com/google/adk-python "adk-python on GitHub") [![TypeScript](https://adk.dev/assets/icon-typescript.svg)JS](https://github.com/google/adk-js "adk-js on GitHub") [![Go](https://adk.dev/assets/icon-go.svg)Go](https://github.com/google/adk-go "adk-go on GitHub") [![Java](https://adk.dev/assets/icon-java.svg)Java](https://github.com/google/adk-java "adk-java on GitHub") [![Kotlin](https://adk.dev/assets/icon-kotlin.svg)Kotlin](https://github.com/google/adk-kotlin "adk-kotlin on GitHub")
...
- [Home](https://adk.dev/)
- [Build Agents](https://adk.dev/get-started/)
- [Run Agents](https://adk.dev/runtime/)
- [Components](https://adk.dev/get-started/about/)
- [Integrations](https://adk.dev/integrations/)
- [Reference](https://adk.dev/api-reference/)
...
Build Agents
  ...
  - [ ]
    ...
    - [Python](https://adk.dev/get-started/python/)
    - [TypeScript](https://adk.dev/get-started/typescript/)
    - [Go](https://adk.dev/get-started/go/)
    - [Java](https://adk.dev/get-started/java/)
    - [Kotlin](https://adk.dev/get-started/kotlin/)
    - [Agents CLI](https://adk.dev/get-started/agents-cli/)
    - [Installation](https://adk.dev/get-started/installation/)
    - [Google Cloud](https://adk.dev/get-started/google-cloud/)
  ...
  - [ ]
    ...
    - [Agent team](https://adk.dev/tutorials/agent-team/)
    - [Code with AI](https://adk.dev/tutorials/coding-with-ai/)
  ...
  - [ ]
    ...
    - [Simple agents](https://adk.dev/agents/llm-agents/)
    - [Managed agents](https://adk.dev/agents/managed-agents/)
  ...
  - [ ]
    ...
    - [ ]
      ...
      - [Loop workflow](https://adk.dev/agents/workflow-agents/loop-agents/)
      - [Parallel workflow](https://adk.dev/agents/workflow-agents/parallel-agents/)
      - [Custom template workflows](https://adk.dev/agents/custom-agents/)

    - [Agent routing](https://adk.dev/agents/routing/)
  ...
  - [ ]
    ...
    - [Gemma](https://adk.dev/agents/models/google-gemma/)
    ...
    - [OpenAI](https://adk.dev/agents/models/openai/)
...
Run Agents
  ...
  - [ ]
    ...
    - [ ]
      ...
      - [Visual Builder](https://adk.dev/visual-builder/)
...
Components
  ...
  - [ ]
    [App management](https://adk.dev/apps/)
  ...
  - [ ]
    [Agent context](https://adk.dev/context/)
    ...
    - [Conversational context](https://adk.dev/sessions/)
    - [ ]
    ...
    - [Model context caching](https://adk.dev/context/caching/)
  ...
  - [ ]
    ...
    - [ ]
      ...
      - [Kotlin](https://adk.dev/a2a/quickstart-consuming-kotlin/)

    - [A2A Extension](https://adk.dev/a2a/a2a-extension/)

  - [ ]
    [Live and Voice Agents](https://adk.dev/live/)
    ...
    - [ ]
      [Get started](https://adk.dev/live/get-started/)
      ...
      - [Python](https://adk.dev/live/get-started/streaming-python/)
      - [Java](https://adk.dev/live/get-started/streaming-java/)
    ...
    - [ ]
      ...
      - [Workflows](https://adk.dev/live/workflows/)
      - [Tools](https://adk.dev/live/tools/)
      - [Sessions](https://adk.dev/live/sessions/)
      - [Events](https://adk.dev/live/events/)
      - [Audio and video](https://adk.dev/live/audio-video/)
      - [Configuration](https://adk.dev/live/configuration/)
    ...
    - [ ]
      ...
      - [Evaluation](https://adk.dev/live/evaluation/)
      - [Build a custom server](https://adk.dev/live/custom-server/)

    - [Supported models](https://adk.dev/live/models/)
...
Reference
  ...
  - [ ]
    ...
    - [Python ADK](https://adk.dev/api-reference/python/)
    - [TypeScript ADK](https://adk.dev/api-reference/typescript/)
    - [ ]
    ...
    - [Java ADK](https://adk.dev/api-reference/java/)
    - [Kotlin ADK](https://adk.dev/api-reference/kotlin/)
    - [CLI Reference](https://adk.dev/api-reference/cli/)
    - [Agent Config Reference](https://adk.dev/api-reference/agentconfig/)
...
Community
  ...
  - [Contributing Guide](https://adk.dev/community/contributing-guide/)
...
[Start building](https://adk.dev/get-started/)
