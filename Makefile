...
.PHONY: help deps gates dryrun test mdc mdc-check native-check docs-analyze all e2e protect-main
...
help:
	...
	@echo "make docs-analyze  # docs inventory, broken links, orphans, readability"
