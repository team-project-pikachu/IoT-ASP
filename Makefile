...
.PHONY: help deps gates dryrun test mdc mdc-check native-check motion-audio-build all e2e protect-main
...
help:
	...
	@echo "make motion-audio-build  # M9 CoreMotion+mic stub SPM (#111)"
