...
Balanced stub-first landing for issues **#41 / #48 / #52** (native) and **#39** (Sonos AirPlay shell), plus **M8** HomeNestAlarm (#102).

| Path | Role |
|------|------|
| [`IoTASP/`](IoTASP/) | Multi-target sketch: iPhone + Watch + shared alarm/impulse/fleet (Swift Package + `.xcodeproj`) |
| [`IoTASPHome/`](IoTASPHome/) | **M8 second feature:** Google Home / Nest + Gemini sound-burst + glass shatter (`make home-ios-build`) |
...
- M8 Home/Nest stub gate: `bash scripts/home_ios_build.sh` or `make home-ios-build`
